...
body.sidebar-hidden #main {
  ...
  .stat-strip-4 { display: grid; grid-template-columns: repeat(4,1fr); gap: 20px; margin-bottom: 2.25rem; }
  ...
  .nav-cards { display: grid; grid-template-columns: repeat(2,1fr); gap: 20px; margin-bottom: 2.25rem; }
  .nav-card {
  ...
  .nav-icon-box.gold { background: var(--gold-light); }
  .nav-icon-box.teal { background: var(--teal-lt); }
  .nav-icon-box svg { width: 20px; height: 20px; fill: none; stroke-width: 1.8; }
  .nav-icon-box.gold svg { stroke: var(--gold-dark); }
  .nav-icon-box.teal svg { stroke: var(--teal); }
  ...
  .badge-answered::before  { background: var(--teal); }
  @keyframes pulse { 0%,100%{opacity:1;transform:scale(1);}50%{opacity:.4;transform:scale(.8);} }

  .two-col { display: grid; grid-template-columns: 1fr 1fr; gap: 30px; margin-bottom: 2.25rem; }
          ...
          <table>
            ...
            <tbody>
              <?php if (empty($recentSurveys)): ?>
                <tr><td colspan="3" style="text-align:center;padding:2rem;color:var(--ink-3);">No answered surveys yet.</td></tr>
              <?php else: ?>
          ...
          <table>
            ...
            <tbody>
              <?php if (empty($pendingSurveys)): ?>
                <tr><td colspan="3" style="text-align:center;padding:2rem;color:var(--ink-3);">All surveys answered!</td></tr>
              <?php else: ?>
