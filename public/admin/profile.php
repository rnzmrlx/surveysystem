...
.page-header h1{font-family:'DM Serif Display',serif;font-size:clamp(1.8rem,3vw,2.6rem);font-weight:400;color:var(--ink);}
.page-header h1 em{font-style:italic;color:var(--gold);}
.page-header p{font-size:13.5px;color:var(--ink-3);margin-top:6px;}

.profile-avatar-wrap{display:flex;align-items:center;gap:1.5rem;margin-bottom:2rem;padding:1.5rem;background:#fff;border:1.5px solid var(--paper-3);border-radius:var(--radius);box-shadow:var(--shadow);}
...
.avatar-info h3{font-size:1.1rem;font-weight:600;color:var(--ink);}
...
.avatar-hint{font-size:11.5px;color:var(--ink-3);margin-top:6px;}
.avatar-hint.preview-active{color:var(--teal);font-weight:500;}
...
.profile-section h3{font-family:'DM Serif Display',serif;font-size:1.1rem;font-weight:400;color:var(--ink);margin-bottom:1.25rem;padding-bottom:10px;border-bottom:1.5px solid var(--paper-2);}
...
.pf-field input{background:var(--paper-2);border:1.5px solid var(--paper-3);border-radius:var(--radius);padding:9px 13px;font-family:'DM Sans',sans-serif;font-size:13.5px;color:var(--ink);outline:none;width:100%;transition:border-color .15s,background .15s;}
.pf-field input:focus{border-color:var(--gold);background:#fff;}
...
.btn-save.saved{background:var(--teal) !important;pointer-events:none;opacity:1;}
...
<?php if ($success && !empty($user['avatar'])): ?>
(function () {
