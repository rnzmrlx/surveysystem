...
// ── Surveys (from surveymanagement.php) ──────────────────────────────────
...
$activeCount   = 0;
$inactiveCount = 0;
$studentSql    = "SELECT id FROM users WHERE role = 'user'";
...
<style>
  ...
  * { box-sizing: border-box; margin: 0; padding: 0; }
  ...
  .stat-strip-2 { display: grid; grid-template-columns: repeat(2,1fr); gap: 14px; margin-bottom: 2.25rem; }
  ...
  .nav-card-arrow { color: var(--ink-3); flex-shrink: 0; }
  .nav-card-arrow svg { width: 14px; height: 14px; stroke: currentColor; fill: none; stroke-width: 2; }
  ...
  .avatar {
    ...
    display: flex; align-items: center; justify-content: center;
    font-size: 11px; font-weight: 700; color: var(--gold-dark); flex-shrink: 0;
  }
  .student-name { font-weight: 500; color: var(--ink); font-size: 13.5px; }
  .student-id   { font-size: 11.5px; color: var(--ink-3); }
...
<div class="main-wrapper">
  ...
  <div class="breadcrumbs">
    <span class="current-page">Dashboard Overview</span>
  </div>
  ...
  <!-- Survey Management Stats -->
  <div class="section-label">
    <h2>Survey <em>Management</em></h2>
    <a href="surveymanagement.php" class="section-link">
      Manage surveys
  ...
  <!-- Students + Analytics side by side -->
  <div class="two-col">
    ...
    <div>
      ...
      <div class="stat-strip-3" style="margin-bottom:1rem;">
        <div class="stat-card gold">
    ...
    <div>
      ...
      <div class="stat-strip-3" style="margin-bottom:1rem;">
        <div class="stat-card gold">
          ...
          <div class="stat-sub">Out of <?= number_format($totalStudents) ?> students</div>
        </div>
        <div class="stat-card teal">
